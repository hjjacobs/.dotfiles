...
sudo scutil --set ComputerName "hjj-macbookpro-2016"
sudo scutil --set HostName "hjj-macbookpro-2016"
sudo scutil --set LocalHostName "hjj-macbookpro-2016"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "dee"
